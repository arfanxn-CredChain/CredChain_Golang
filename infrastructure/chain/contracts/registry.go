...
// GetCredentialHashPerHolderStatuses is a free data retrieval call binding the contract method 0xaeca1208.
//
// Solidity: function getCredentialHashPerHolderStatuses(address[] holders, bytes32[] hashes) view returns((bytes32,uint8)[])
func (_Registry *RegistryCaller) GetCredentialHashPerHolderStatuses(opts *bind.CallOpts, holders []common.Address, hashes [][32]byte) ([]CredentialRegistryCredentialHashStatus, error) {
	var out []interface{}
	err := _Registry.contract.Call(opts, &out, "getCredentialHashPerHolderStatuses", holders, hashes)
...
//
// Solidity: function getCredentialHashPerHolderStatuses(address[] holders, bytes32[] hashes) view returns((bytes32,uint8)[])
func (_Registry *RegistrySession) GetCredentialHashPerHolderStatuses(holders []common.Address, hashes [][32]byte) ([]CredentialRegistryCredentialHashStatus, error) {
	return _Registry.Contract.GetCredentialHashPerHolderStatuses(&_Registry.CallOpts, holders, hashes)
}

// GetCredentialHashPerHolderStatuses is a free data retrieval call binding the contract method 0xaeca1208.
//
// Solidity: function getCredentialHashPerHolderStatuses(address[] holders, bytes32[] hashes) view returns((bytes32,uint8)[])
func (_Registry *RegistryCallerSession) GetCredentialHashPerHolderStatuses(holders []common.Address, hashes [][32]byte) ([]CredentialRegistryCredentialHashStatus, error) {
	return _Registry.Contract.GetCredentialHashPerHolderStatuses(&_Registry.CallOpts, holders, hashes)
}
...
// HolderToCredentialHashStatus is a free data retrieval call binding the contract method 0xf2a3a3c4.
//
// Solidity: function holderToCredentialHashStatus(address , bytes32 ) view returns(uint8)
func (_Registry *RegistryCaller) HolderToCredentialHashStatus(opts *bind.CallOpts, arg0 common.Address, arg1 [32]byte) (uint8, error) {
	var out []interface{}
	err := _Registry.contract.Call(opts, &out, "holderToCredentialHashStatus", arg0, arg1)
...
//
// Solidity: function holderToCredentialHashStatus(address , bytes32 ) view returns(uint8)
func (_Registry *RegistrySession) HolderToCredentialHashStatus(arg0 common.Address, arg1 [32]byte) (uint8, error) {
	return _Registry.Contract.HolderToCredentialHashStatus(&_Registry.CallOpts, arg0, arg1)
}

// HolderToCredentialHashStatus is a free data retrieval call binding the contract method 0xf2a3a3c4.
//
// Solidity: function holderToCredentialHashStatus(address , bytes32 ) view returns(uint8)
func (_Registry *RegistryCallerSession) HolderToCredentialHashStatus(arg0 common.Address, arg1 [32]byte) (uint8, error) {
	return _Registry.Contract.HolderToCredentialHashStatus(&_Registry.CallOpts, arg0, arg1)
}
